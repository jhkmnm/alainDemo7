...
export class ApiServiceProxy {
  ...
  productPost(productName: string, price: number | undefined): Observable<void> {
    ...
    if (productName === undefined || productName === null)
      throw new Error("The parameter 'productName' must be defined and cannot be null.");
...
export class DicServiceProxy {
  ...
  get(dicCode: string | null | undefined): Observable<DicCacheItem> {
    ...
    return this.http.request('get', url_, options_).pipe(
      _observableMergeMap((response_: any) => {
        console.log('第一个processGet' + response_);
        return this.processGet(response_);
      }),
    );
    // .pipe(_observableCatch((response_: any) => {
    //     return _observableOf<DicCacheItem>(<any>null);
    //     // console.log("第二个pipe"+ response_);
    //     // if (response_ instanceof HttpResponseBase) {
    //     //     try {
    //     //         console.log("第二个processGet"+ response_);
    //     //         // return this.processGet(<any>response_);
    ...
    //     //     }
    //     // } else{
    //     //     console.log("最后一个else"+ response_);
    //     //     return <Observable<DicCacheItem>><any>_observableThrow(response_);
    //     // }
    // }));
  }
...
export class OrderServiceProxy {
  ...
  getEntityPropertyChanges(
  ...
  ): Observable<EntityPropertyChangeDto[]> {
    ...
    else if (excludeAuditProperties !== undefined)
      url_ += 'excludeAuditProperties=' + encodeURIComponent('' + excludeAuditProperties) + '&';
    url_ = url_.replace(/[?&]$/, '');
...
export class TenantServiceProxy {
   ...
   */
  getPaged(
    subscriptionStart: moment.Moment | null | undefined,
    subscriptionEnd: moment.Moment | null | undefined,
...
export class UserServiceProxy {
  ...
  getPaged(
    ...
    if (isEmailConfirmed !== undefined && isEmailConfirmed !== null)
...
export class HangFireStorageJob implements IHangFireStorageJob {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.resultState = _data['resultState'];
      this.retryAt = _data['retryAt'] ? moment(_data['retryAt'].toString()) : <any>undefined;
      this.enqueueAt = _data['enqueueAt'] ? moment(_data['enqueueAt'].toString()) : <any>undefined;
...
export class RecurringListJobDto implements IRecurringListJobDto {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.nextExecution = _data['nextExecution'] ? moment(_data['nextExecution'].toString()) : <any>undefined;
...
export class HangfireJobDetailDto implements IHangfireJobDetailDto {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.expireAt = _data['expireAt'] ? moment(_data['expireAt'].toString()) : <any>undefined;
      this.jobName = _data['jobName'];
...
export class RetriesJobListDto implements IRetriesJobListDto {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.jobName = _data['jobName'];
      this.reason = _data['reason'];
      this.retryTime = _data['retryTime'] ? moment(_data['retryTime'].toString()) : <any>undefined;
...
export class RetriesResultList implements IRetriesResultList {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.retriesJobListDtos = _data['retriesJobListDtos']
        ? RetriesJobListDtoPagedResultDto.fromJS(_data['retriesJobListDtos'])
        : <any>undefined;
    }
  }
...
export class HangfireServerListDto implements IHangfireServerListDto {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.heartbeat = _data['heartbeat'] ? moment(_data['heartbeat'].toString()) : <any>undefined;
    }
  }
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.passwordComplexity = _data['passwordComplexity']
        ? PasswordComplexitySetting.fromJS(_data['passwordComplexity'])
        : <any>undefined;
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.signInTokenExpireTimeUtc = _data['signInTokenExpireTimeUtc']
        ? moment(_data['signInTokenExpireTimeUtc'].toString())
        : <any>undefined;
      this.concurrencyStamp = _data['concurrencyStamp'];
      ...
      if (_data['allFeatures']) {
        ...
        for (let key in _data['allFeatures']) {
          if (_data['allFeatures'].hasOwnProperty(key))
            this.allFeatures[key] = _data['allFeatures'][key]
              ? AbpStringValueDto.fromJS(_data['allFeatures'][key])
